...
func main() {
	...
	area := rect.AreaOfRect(rct) //its contain own copy of rect
	...
	fmt.Println("Area of Square that is stored inside square", sq.Area)
	fmt.Println("Perimeter of Square that is stored inside square", sq.Perimeter)
	fmt.Println()
}
